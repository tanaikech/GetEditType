...
function Do(eventObject) {
  ...
  if (
    cellValues.length > 1 ||
    cellValues[0].length > 1 ||
    cellFormulas.length > 1 ||
    cellFormulas[0].length > 1
  ) {
    obj.editCell = "MULTIPLE";

    if (
      eventObject.value == null &&
      eventObject.oldValue == null &&
      !cellValues.check() &&
      !cellFormulas.check()
    ) {
      ...
      eventObject.value == null &&
      eventObject.oldValue == null &&
      (cellValues.check() || cellFormulas.check())
    ) {
    ...
    if (eventObject.value != null && eventObject.oldValue == null) {
      ...
      eventObject.oldValue != undefined &&
      "value" in eventObject &&
      eventObject.value != "" &&
      typeof eventObject.value != "object"
    ) {
      ...
      (eventObject.value == null &&
        ...
        !cellValues.check() &&
        !cellFormulas.check()) ||
      (!("value" in eventObject) && eventObject.oldValue != "") ||
      typeof eventObject.value == "object"
    ) {
